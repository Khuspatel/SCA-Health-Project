class synapseConnect {
    get synapseConnectPageTitle() { return cy.get('h3[class="et_pb_module_header"]').contains('Who typically uses the Connect solution?') }
    get synapseConnectTitle() { return cy.get('h3') }
...
export default new synapseConnect();